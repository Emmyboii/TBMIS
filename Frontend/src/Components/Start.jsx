            ...
            <div className='py-10 se:px-24 px-10'>
                ...
                <ul className='grid ma:grid-cols-3 sp:grid-cols-2 gap-10 mt-4'>
                    <li data-aos="fade-up" data-aos-delay="600" className='aos-init bg-[#01022e] text-white shadow-inner shadow-gray-600 text-center rounded-xl py-7 px-4'>
                        ...
                        <p className='text-[19px]'>Apply to see if you qualify for a scholarship <a href='#apply' className='bg-orange-600 text-center font-semibold text-white hover:scale-75 duration-300'>here</a>.</p>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="800" className='aos-init bg-[#01022e] text-white shadow-inner shadow-gray-600 text-center rounded-xl py-7 px-4'>
                        <p className='font-bold flex items-center justify-center text-[30px] text-orange-500'><IoMdDoneAll /></p>
                    ...
                    <li data-aos="fade-up" data-aos-delay="1000" className='aos-init bg-[#01022e] text-white shadow-inner shadow-gray-600 text-center rounded-xl py-7 px-4'>
                        <p className='font-bold flex items-center justify-center text-[30px] text-orange-500'><IoMdDoneAll /></p>
